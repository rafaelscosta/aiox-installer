...
6. **Faz checkout** da versão escolhida (default: `v1.0.3-imersao`)
...
| `--version <tag>` | Versão do cockpit a instalar (default: `v1.0.3-imersao`) |
...
O wizard v1.0.2 resolve comandos pelo `PATHEXT` do Windows, então executáveis
