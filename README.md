...
6. **Faz checkout** da versão escolhida (default: `v1.0.4-imersao`)
...
| `--version <tag>` | Versão do cockpit a instalar (default: `v1.0.4-imersao`) |
...
npx github:rafaelscosta/aiox-installer --version v1.0.4-imersao
```
...
O wizard v1.0.3 resolve comandos pelo `PATHEXT` do Windows, então executáveis
